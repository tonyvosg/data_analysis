...
hist.title = "Results of rolling three D6" + str(roll_num) + " times."
hist.x_title = "Result"
...
#open file
safari = app("Safari")
safari.make(new = k.document, with_properties={k.URL:"file:///Users/tungvo/Desktop/data_analysis/three_dice_visual.svg"})
